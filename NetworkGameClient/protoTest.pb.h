...
class Leaderboard : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Leaderboard) */ {
 public:
  ...
  bool has_winners() const;
  void clear_winners();
  static const int kWinnersFieldNumber = 1;
  const ::std::string& winners() const;
  void set_winners(const ::std::string& value);
  void set_winners(const char* value);
  void set_winners(const char* value, size_t size);
  ::std::string* mutable_winners();
  ::std::string* release_winners();
  void set_allocated_winners(::std::string* winners);

  // optional string losers = 2;
  bool has_losers() const;
  void clear_losers();
  static const int kLosersFieldNumber = 2;
  const ::std::string& losers() const;
  void set_losers(const ::std::string& value);
  void set_losers(const char* value);
  void set_losers(const char* value, size_t size);
  ::std::string* mutable_losers();
  ::std::string* release_losers();
  void set_allocated_losers(::std::string* losers);

  // @@protoc_insertion_point(class_scope:Leaderboard)
 private:
  inline void set_has_winners();
  inline void clear_has_winners();
  inline void set_has_losers();
  inline void clear_has_losers();

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable int _cached_size_;
  ::google::protobuf::internal::ArenaStringPtr winners_;
  ::google::protobuf::internal::ArenaStringPtr losers_;
  friend void  protobuf_InitDefaults_protoTest_2eproto_impl();
  friend void  protobuf_AddDesc_protoTest_2eproto_impl();
  friend void protobuf_AssignDesc_protoTest_2eproto();
  friend void protobuf_ShutdownFile_protoTest_2eproto();
...
class Game : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Game) */ {
 public:
  ...
  const ::Player& player1() const;
  ::Player* mutable_player1();
  ::Player* release_player1();
  void set_allocated_player1(::Player* player1);
  ...
  ::Player* mutable_player2();
  ::Player* release_player2();
  void set_allocated_player2(::Player* player2);

  // required .Army army1 = 3;
  bool has_army1() const;
  void clear_army1();
  static const int kArmy1FieldNumber = 3;
  ...
  void clear_army2();
  static const int kArmy2FieldNumber = 4;
...
// optional string winners = 1;
inline bool Leaderboard::has_winners() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Leaderboard::set_has_winners() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Leaderboard::clear_has_winners() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline const ::std::string& Leaderboard::winners() const {
...
inline void Leaderboard::set_winners(const ::std::string& value) {
  set_has_winners();
...
inline void Leaderboard::set_winners(const char* value) {
  set_has_winners();
...
inline void Leaderboard::set_winners(const char* value, size_t size) {
  set_has_winners();
...
inline ::std::string* Leaderboard::mutable_winners() {
  set_has_winners();
...
inline ::std::string* Leaderboard::release_winners() {
...
inline void Leaderboard::set_allocated_winners(::std::string* winners) {
  if (winners != NULL) {
    set_has_winners();
  } else {
    clear_has_winners();
...
// optional string losers = 2;
inline bool Leaderboard::has_losers() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Leaderboard::set_has_losers() {
  _has_bits_[0] |= 0x00000002u;
}
inline void Leaderboard::clear_has_losers() {
  _has_bits_[0] &= ~0x00000002u;
}
...
inline const ::std::string& Leaderboard::losers() const {
...
inline void Leaderboard::set_losers(const ::std::string& value) {
  set_has_losers();
...
inline void Leaderboard::set_losers(const char* value) {
  set_has_losers();
...
inline void Leaderboard::set_losers(const char* value, size_t size) {
  set_has_losers();
...
inline ::std::string* Leaderboard::mutable_losers() {
  set_has_losers();
...
inline ::std::string* Leaderboard::release_losers() {
...
inline void Leaderboard::set_allocated_losers(::std::string* losers) {
  if (losers != NULL) {
    set_has_losers();
  } else {
    clear_has_losers();
